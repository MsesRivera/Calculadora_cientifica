package equiponaranja.tirovertical;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtH1=(EditText)findViewById(R.id.edtH1);
        edtVo1=(EditText)findViewById(R.id.edtVo1);
        edtT1=(EditText)findViewById(R.id.edtT1);
        edtG1=(EditText)findViewById(R.id.edtG1);
        edtV2=(EditText)findViewById(R.id.edtV2);
        edtVo2=(EditText)findViewById(R.id.edtVo2);
        ...
        txvT1=(TextView)findViewById(R.id.txvT1);
